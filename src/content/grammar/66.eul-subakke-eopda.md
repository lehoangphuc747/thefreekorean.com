...
| **Không cuối** | V/A + **-ㄹ 수밖에 없다** | 가다 → **갈 수밖에 없다**<br>주다 → **줄 수밖에 없다**<br>크다 → **클 수밖에 없다**<br>예쁘다 → **예쁠 수밖에 없다** |
| **Cuối ㄹ** | ㄹ rụng + **-ㄹ 수밖에 없다** | 놀다 → **놀 수밖에 없다**<br>만들다 → **만들 수밖에 없다** |
| **이다** | N이 + **-ㄹ 수밖에 없다** | 계란이다 → 계란**일 수밖에 없다**<br>이불이다 → 이불**일 수밖에 없다**<br>친구이다 → 친구**일 수밖에 없다** |
| **아니다** | 아니 + **-ㄹ 수밖에 없다** | 아니다 → **아닐 수밖에 없다** |
...
|---|---|---|
| 타다 | **탈 수밖에 없다** | 버스가 끊겨서 택시를 탈 수밖에 없어요. |
| 보다 | **볼 수밖에 없다** | 5시 표는 매진이 되어서 7시에 볼 수밖에 없어요. |
| 기다리다 | **기다릴 수밖에 없다** | 수지 씨가 올 때까지 기다릴 수밖에 없어요. |
| 크다 | **클 수밖에 없다** | 매일 농구를 하니까 키가 클 수밖에 없어요. |
| 알다 | **알 수밖에 없다** | 5년 살았으니 한국에 대해 잘 알 수밖에 없어요. |
| 먹다 | 먹**을 수밖에 없다** | 머리가 너무 아파서 약을 먹**을 수밖에 없다**. |
| 많다 | 많**을 수밖에 없다** | 주말에는 시내에 사람이 많**을 수밖에 없다**. |
| 어렵다 | **어려울 수밖에 없다** | 한국어를 처음 배울 때는 어려울 수밖에 없다. |
...
| **덥다** | **더울 수밖에 없다** | 여름이니까 더울 수밖에 없어요. |
| **붓다** | 부**을 수밖에 없다** | 하루 종일 서 있으면 다리가 부**을 수밖에 없습니다**. |
| **그렇다** | **그럴 수밖에 없다** | 그럴 수밖에 없었습니다. |
...
|---|---|---|---|
| **1. KHÔNG CÒN CÁCH KHÁC<br>(다른 방법이 없다)** | CHỈ có MỘT lựa chọn duy nhất | 버스가 끊겨서 택시를 **탈 수밖에 없어요**. | KHÔNG có lựa chọn khác |
...
|---|---|---|
| 기다릴 수밖에 없어요 | 기다리**는 수밖에 없어요** | Dùng **-는 수밖에** để NHẤN MẠNH |
| 갈 수밖에 없어요 | 가**는 수밖에 없어요** | Chỉ dùng với ĐỘNG TỪ |
