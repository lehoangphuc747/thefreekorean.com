...
title: "-(스)ㅂ니다 (Đuôi câu trần thuật trang trọng)"
...
# 🎓 [-(스)ㅂ니다] - [Đuôi câu trần thuật trang trọng]
...
| :--- | :--- | :--- |
| **Có patchim** (phụ âm cuối) | `+ 습니다` | 먹다 $\rightarrow$ **먹습니다** (ăn)<br>읽다 $\rightarrow$ **읽습니다** (đọc)<br>좋다 $\rightarrow$ **좋습니다** (tốt) |
| **Không có patchim** (nguyên âm) | `+ ㅂ니다` | 가다 $\rightarrow$ **갑니다** (đi)<br>자다 $\rightarrow$ **잡니다** (ngủ)<br>예쁘다 $\rightarrow$ **예쁩니다** (đẹp) |
| **Bất quy tắc Patchim 'ㄹ'** | **Bỏ `ㄹ`** `+ ㅂ니다` | 살다 (sống) $\rightarrow$ sa + ㅂ니다 $\rightarrow$ **삽니다**<br>만들다 (làm) $\rightarrow$ mandu + ㅂ니다 $\rightarrow$ **만듭니다** |
| **Danh từ** | `+ 입니다` | 학생 $\rightarrow$ **학생입니다**<br>의사 $\rightarrow$ **의사입니다** |
...
1. 가다 $\rightarrow$ ____________
2. 웃다 (cười) $\rightarrow$ ____________
3. 바쁘다 (bận) $\rightarrow$ ____________
4. 멀다 (xa) $\rightarrow$ ____________
5. 운동선수 (Vận động viên) $\rightarrow$ ____________
