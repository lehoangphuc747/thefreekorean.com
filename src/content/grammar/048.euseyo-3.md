...
Khi động từ có phụ âm cuối **ㅎ** gặp nguyên âm, **ㅎ** bị tách.

| Động từ gốc | Chia với -(으)세요 | Giải thích |
|-------------|-------------------|------------|
| 빨갛다 (đỏ) | 빨개세요 | Tính từ (KHÔNG dùng -(으)세요 3!) |
...
**Từ vựng gợi ý:**
- 쓰다 (viết), 읽다 (đọc), 듣다 (nghe), 말하다 (nói), 보다 (xem)
- 앉다 (ngồi), 일어나다 (đứng lên), 나가다 (ra ngoài), 들어오다 (vào trong)
...
**Từ vựng gợi ý:**
- 돕다 (giúp), 가르치다 (dạy), 주다 (cho), 빌리다 (mượn)
- 기다리다 (đợi), 설명하다 (giải thích), 보여주다 (cho xem)
...
**Từ vựng gợi ý:**
- 먹다 (ăn), 마시다 (uống), 자다 (ngủ), 씻다 (rửa)
- 청소하다 (dọn dẹp), 요리하다 (nấu ăn), 쉬다 (nghỉ ngơi)
